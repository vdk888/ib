...
# from .api.v1.endpoints.pipeline import router as pipeline_router  # temporarily disabled
...
# app.include_router(pipeline_router, prefix="/api/v1")  # temporarily disabled
